...
var myObject = {
			...
			if(browser.versions.mobile) {
				...
				if(type == "TOUR") {
					...
					if(browser.versions.android) {
						var jsonstr = {
							"from": $(this).attr("data-type"),
							"callback": "myObject.addLoginCallback"
						};
					} else if(browser.versions.ios) {
						var jsonstr = {
							"from": $(this).attr("data-type"),
							"callback": "myObject.addLoginCallback_"
						};
					}
	...
	addStatisticsEvent: function(Op, clickJson) {
		...
		if(aid == undefined || aid == null || aid == "") {
			aid = myObject.GetQueryString("aid");
		}
		console.log(aid);
...
(function() {
	...
	if(browser.versions.android) {
		...
		console.log(channel.indexOf("AHlpm"))
